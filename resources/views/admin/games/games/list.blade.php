...
@section('content')
    @include('layouts.components.admin.contentheader', ['title' => __('games'),'breadcrumbs'=>[__('games')=>'#']])
    <section class="content bcg-white">
        <a href="{{route('games.create')}}" role="button" class="btn btn-primary btn-flat pull-right">
        ...
        <table class="table table-hover orderable">
            ...
            @forelse ($rows as $row)
                <tr>
                    ...
                    <td>
                        <a href="{{route('games.edit', $row->id)}}" class="btn btn-flat btn-default pull-right">
                            <i class="fa fa-lg fa-edit">
                                <span class="sr-only">{{__('edit')}}</span>
                            </i>
                        </a>
                        <a href="{{route('games.show', $row->id)}}" role="button"
