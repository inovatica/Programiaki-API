...
@section('content')
    @include('layouts.components.admin.contentheader', ['title' => __('add').' '.__('group'),'breadcrumbs'=>[__('groups')=>'/admin/groups',__('add')=>'#']])
        ...
        <form role="form" method="POST">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="babysitter_id" name="babysitter_id" disabled></select>
                </div>
            </div>
        ...
        if ($('#institution_id').val()) {
            axios({
              ...
              data: {
                ...
                $('#babysitter_id').attr('disabled', false);
            });
        }
    };
    getBabysitters();
